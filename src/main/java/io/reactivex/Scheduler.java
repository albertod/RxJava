...
public abstract class Scheduler {
    ...
    public abstract static class Worker implements Disposable {
         ...
         */
        public abstract Disposable schedule(Action0 action);
         ...
         * @return a subscription to be able to unsubscribe the action (unschedule it if not executed)
         */
        public abstract Disposable schedule(final Action0 action, final long delayTime, final TimeUnit unit);
         ...
         * @return a subscription to be able to unsubscribe the action (unschedule it if not executed)
         */
        public Disposable schedulePeriodically(final Action0 action, long initialDelay, long period, TimeUnit unit) {
            ...
            // Should call `mas.set` before `schedule`, or the new Disposable may replace the old one.
            mas.set(s);
